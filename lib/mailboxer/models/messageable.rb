module Mailboxer
  module Models
    module Messageable
      ...
      def notify(subject, body, notified_obj=nil, context_obj=nil, target_obj=nil,
        sanitize_text=true, notification_code=nil, notification_group=nil, send_mail=true, sender=nil)
        Mailboxer::Notification.notify_all([self], subject, body, notified_obj, context_obj,
          target_obj, sanitize_text, notification_code, notification_group, send_mail, sender)
      end
